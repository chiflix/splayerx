export default {
  msg: {
    ...
    subtitle: {
      ...
      increaseSubtitleDelayS: 'Increase Subtitle Delay +0.1s',
      decreaseSubtitleDelayS: 'Decrease Subtitle Delay -0.1s',
      increaseSubtitleDelayL: 'Increase Subtitle Delay +0.5s',
      decreaseSubtitleDelayL: 'Decrease Subtitle Delay -0.5s',
    },
    window: {
      name: 'Window',
      minimize: 'Minimize',
