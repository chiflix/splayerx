...
export const Subtitle = {
  ...
  CURRENT_SUBTITLE_ID_UPDATE: 'CURRENT_SUBTITLE_ID_UPDATE',
  RESET_SUBTITLES: 'RESET_SUBTITLES',
};

export const Input = {
  MOUSEMOVE_POSITION_UPDATE: 'MOUSEMOVE_POSITION_UPDATE',
  MOUSEMOVE_TARGET_UPDATE: 'MOUSEMOVE_TARGET_UPDATE',
  MOUSEDOWN_BUTTONS_UPDATE: 'MOUSEDOWN_BUTTONS_UPDATE',
  MOUSEDOWN_TARGET_UPDATE: 'MOUSEDOWN_TARGET_UPDATE',
  MOUSEUP_TARGET_UPDATE: 'MOUSEUP_TARGET_UPDATE',
  DOWN_KEYS_UPDATE: 'DOWN_KEYS_UPDATE',
  WHEEL_TARGET_UPDATE: 'WHEEL_TARGET_UPDATE',
