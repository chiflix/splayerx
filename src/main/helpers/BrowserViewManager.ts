...
export class BrowserViewManager implements IBrowserViewManager {
  ...
  public constructor() {
    ...
    this.history = [];
    this.multiPagesChannel = ['youtube.com', 'iqiyi.com', 'bilibili.com', 'douyu.com', 'huya.com', 'twitch.com', 'coursera.com', 'ted.com', 'lynda.com', 'masterclass.com', 'sportsqq.com', 'apple.com', 'open163.com'];
