...
describe('shared/utils', () => {
  it('should contains proper subtitle extensions', () => {
    ...
    expect(isSubtitle('filename.vtt')).to.be(true);
    expect(isSubtitle('filename.ASS')).to.be(true);
  });
  ...
  it('should contains proper video extensions', () => {
    ...
    expect(isVideo('filename.mkv')).to.be(true);
    expect(isVideo('filename.WMV')).to.be(true);
  });
