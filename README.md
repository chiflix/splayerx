...
- 有可能导致阻塞的操作，例如IO读写或者CPU intensive tasks，应该尽量放在基于 electron-remote 创建的 separate process 里面。参考：[Deep dive into Electron’s main and renderer processes](https://medium.com/cameron-nokes/deep-dive-into-electrons-main-and-renderer-processes-7a9599d5c9e2)
